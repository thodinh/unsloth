...
print(f'pip install --upgrade pip && pip install --no-deps git+https://github.com/thodinh/unsloth-zoo.git && pip install "unsloth[{x}] @ git+https://github.com/thodinh/unsloth.git" --no-build-isolation')